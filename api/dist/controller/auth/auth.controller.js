...
const sign_up_dto_1 = require("../../core/dto/auth/sign-up.dto");
let AuthController = class AuthController {
    constructor(authService) {
        this.authService = authService;
    }
    async signUpPassenger(createUserDto) {
        const res = {};
        try {
    ...
    async loginDriver(loginUserDto) {
        const res = {};
        try {
...
__decorate([
    (0, common_1.Post)("signUp/passenger"),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [sign_up_dto_1.SignUpPassengerUserDto]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "signUpPassenger", null);
__decorate([
